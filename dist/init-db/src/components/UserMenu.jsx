...
function UserMenu() {
    ...
    return (<div className="relative inline-block text-left">
      <div className="flex items-center gap-2 cursor-pointer" onClick={() => setOpen(!open)}>
        ...
        <outline_1.ChevronDownIcon className="w-5 h-5 text-gray-600"/>
      </div>

      {open && (<div className="absolute right-0 mt-2 w-48 origin-top-right bg-white border border-gray-200 rounded-lg shadow-lg z-10">
          <div className="py-1">
